...
public class D3DTX_V3 : ID3DTX
{
  ...
  public string GetDebugInfo(TelltaleToolGame game = TelltaleToolGame.DEFAULT, T3PlatformType platform = T3PlatformType.ePlatform_None)
  {
    ...
    d3dtxInfo.AppendFormat("mSamplerState Block Size: {0}", mSamplerState_BlockSize).Append(Environment.NewLine);
    d3dtxInfo.AppendFormat("mSamplerState: {0}", mSamplerState).Append(Environment.NewLine);
    d3dtxInfo.AppendFormat("mPlatformType Block Size: {0}", mPlatform_BlockSize).Append(Environment.NewLine);
    d3dtxInfo.AppendFormat("mPlatformType: {0} ({1})", Enum.GetName(typeof(T3PlatformType), (int)mPlatform), mPlatform).Append(Environment.NewLine);
    ...
    d3dtxInfo.AppendFormat("mAlphaMode: {0} ({1})", Enum.GetName(typeof(T3TextureAlphaMode), (int)mAlphaMode), mAlphaMode).Append(Environment.NewLine);
    d3dtxInfo.AppendFormat("mColorMode: {0} ({1})", Enum.GetName(typeof(T3TextureColor), (int)mColorMode), mColorMode).Append(Environment.NewLine);
    ...
    d3dtxInfo.AppendFormat("mToonRegions Array Capacity: {0}", mToonRegions_ArrayCapacity).Append(Environment.NewLine);
    d3dtxInfo.AppendFormat("mToonRegions Array Length: {0}", mToonRegions_ArrayLength).Append(Environment.NewLine);
    for (int i = 0; i < mToonRegions_ArrayLength; i++)
    {
