...
public class D3DTX_V9 : ID3DTX
{
    ...
    public string GetDebugInfo(TelltaleToolGame game = TelltaleToolGame.DEFAULT, T3PlatformType platform = T3PlatformType.ePlatform_None)
    {
        ...
        d3dtxInfo.AppendLine("||||||||||| D3DTX Version 9 Header |||||||||||");
        ...
        d3dtxInfo.AppendFormat("mSamplerState: {0}", mSamplerState.ToString()).Append(Environment.NewLine);
        d3dtxInfo.AppendFormat("mPlatform_BlockSize: {0}", mPlatform_BlockSize).Append(Environment.NewLine);
        d3dtxInfo.AppendFormat("mPlatform: {0} ({1})", Enum.GetName(typeof(T3PlatformType), (int)mPlatform), (int)mPlatform).Append(Environment.NewLine);
        ...
        d3dtxInfo.AppendFormat("mDepth: {0}", mDepth).Append(Environment.NewLine);
        d3dtxInfo.AppendFormat("mArraySize: {0}", mArraySize).Append(Environment.NewLine);
        ...
        d3dtxInfo.AppendFormat("mSurfaceMultisample: {0} ({1})", Enum.GetName(typeof(T3SurfaceMultisample), mSurfaceMultisample), (int)mSurfaceMultisample).Append(Environment.NewLine);
        ...
        d3dtxInfo.AppendLine("----------- mArrayFrameNames -----------");
        d3dtxInfo.AppendFormat("mArrayFrameNames_ArrayCapacity: {0}", mArrayFrameNames_ArrayCapacity).Append(Environment.NewLine);
        d3dtxInfo.AppendFormat("mArrayFrameNames_ArrayLength: {0}", mArrayFrameNames_ArrayLength).Append(Environment.NewLine);
        for (int i = 0; i < mArrayFrameNames_ArrayLength; i++)
        {
            d3dtxInfo.AppendFormat("mArrayFrameName {0}: {1}", i, mArrayFrameNames[i]).Append(Environment.NewLine);
        }
        ...
        d3dtxInfo.AppendLine("----------- RegionStreamHeader -----------");

        for (int i = 0; i < mStreamHeader.mRegionCount; i++)
        {
            d3dtxInfo.AppendFormat("Region {0}:", i).Append(Environment.NewLine);
            ...
            d3dtxInfo.AppendFormat("mSlicePitch: {0}", mRegionHeaders[i].mSlicePitch).Append(Environment.NewLine);
        }
